                  ...
                  <div className='container'>
                     <div className='row'>
                        <div className='col-4'>
                           <div class="form-check-inline" >
                              <label class="form-check-label" style={{ fontSize: '14px', fontWeight: '100' }}>
                                 <input type="radio" class="form-check-input" />Face To face Meeting
                              </label>
                           </div>
                        </div>
                        <div className='col-4'>
                           <div class="form-check-inline" >
                              <label class="form-check-label" style={{ fontSize: '14px', fontWeight: '100' }}>
                                 <input type="radio" class="form-check-input" />Online Meeting
                              </label>
                           </div>
                        </div>
                        <div className='col-4'>
                           <div class="form-check-inline" >
                              <label class="form-check-label" style={{ fontSize: '14px', fontWeight: '100' }}>
                                 <input type="radio" class="form-check-input" />Both Face to face & Online
                              </label>
                           </div>
                        </div>
            ...
            <div className='col-lg-4 col-md-4 col-sm-12 col-xs-12 compact-list-layout'>
               <a className="utf-job-listing" style={{ marginBottom: '30px',background:'#efefef' }}>
                  ...
                  <input type="radio" id="male" name="gender" value="male" />
                     <label for="male" style={{ fontSize: '14px', fontWeight: '100' }}>Basic Computer</label><br />
                        <input type="radio" id="female" name="gender" value="female"/>
                           <label for="female" style={{ fontSize: '14px', fontWeight: '100' }}>Language </label><br />
                              <input type="radio" id="other" name="gender" value="other" />
                                 <label for="other" style={{ fontSize: '14px', fontWeight: '100' }}>Graphic & Design</label>
                  </a>
                  ...
                  <label for="exampleInputEmail1" style={{ fontSize: '14px', fontWeight: '100' }}>City</label>
                           ...
                           <label for="exampleInputEmail1" style={{ fontSize: '14px', fontWeight: '100' }}>Area</label>
                           <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mumbai" style={{ fontSize: '14px', fontWeight: '100' }} />
                  </a>
